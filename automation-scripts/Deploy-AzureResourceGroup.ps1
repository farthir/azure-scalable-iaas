...
$vmssNameAffix = Get-AutomationVariable -Name 'vmssNameAffix'
...
$OptionalParameters.Add("vmssNameAffix", $vmssNameAffix)
$OptionalParameters.Add("adminUsername", $adminUsername)
$OptionalParameters.Add("adminPassword", $adminPassword)
$OptionalParameters.Add("chefServerUrl", $chefServerUrl)
$OptionalParameters.Add("chefValidationClientName", $chefValidationClientName)
